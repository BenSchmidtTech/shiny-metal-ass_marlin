...
#define STRING_CONFIG_H_AUTHOR "Brent Rogers" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "ShinyMetalAss"
...
// If your configuration is ignificantly different than this and you don't understand the issues involved, you probably
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER .70
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,655}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {500, 500, 3, 25}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {9000,1000,100,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
